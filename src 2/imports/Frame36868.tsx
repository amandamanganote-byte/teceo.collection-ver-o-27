  ...
  return (
    <div className="absolute contents left-0 top-0" data-name="description">
      ...
      <div className="absolute font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[normal] left-[46px] text-[24px] text-white top-[160px] w-[754px] whitespace-pre-wrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        <p className="mb-0">{`uma agenda estratégica sobre as transformações que já estão redefinindo o B2B de moda e lifestyle: da digitalização superficial à construção de modelos orientados por inteligência, dados e previsibilidade. `}</p>
        <p>um conteúdo direto ao ponto, voltado para quem decide e conduz a transformação dentro das empresas.</p>
      </div>
