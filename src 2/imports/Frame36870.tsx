  ...
  return (
    <div className="absolute contents left-0 top-0" data-name="description">
      ...
      <div className="absolute font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[normal] left-[46px] text-[24px] text-white top-[160px] w-[754px] whitespace-pre-wrap" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
        <p className="mb-0">{`um encontro fechado com C‑levels e fundadores de grandes marcas de moda e lifestyle, criado para promover trocas reais entre pares. `}</p>
        <p>aqui, você vai discutir como outras lideranças estão estruturando o crescimento do B2B, enfrentando seus gargalos e redesenhando seus modelos de distribuição na prática.</p>
      </div>
